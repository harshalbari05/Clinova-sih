...
export const authApi = {
  async register(payload: PatientRegisterPayload): Promise<{ user: User; account_type: string; patient?: Patient }> {
    const res = await api.post('/auth/patient/register', payload);
    return res.data;
  },
