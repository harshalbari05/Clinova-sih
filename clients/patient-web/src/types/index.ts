/**
 * Clinova Backend API Type Definitions
...
export type ConsultationStatus = 'initiated' | 'in_progress' | 'completed' | 'reviewed' | 'cancelled';
...
export type TriagePriority = 'red' | 'orange' | 'yellow' | 'green' | 'EMERGENCY' | 'URGENT' | 'NORMAL' | string;
...
export type DocumentType = 'prescription' | 'lab_report' | 'radiology_scan' | 'discharge_summary' | 'other' | string;
export type UploadStatus = 'pending' | 'uploading' | 'uploaded' | 'processing' | 'processed' | 'failed' | string;
...
export interface StructuredExtraction {
  ...
  medications?: Array<any> | null;
  laboratory_results?: Array<any> | null;
